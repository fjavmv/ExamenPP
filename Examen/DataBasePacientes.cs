...
namespace Examen
{
    internal class DataBasePacientes
    {
        ...
        public ModeloPaciente ConsultaDos(string dato)
        {
            ...
            //4. consulta
            string QUERY_CONSULTA = string.Format("SELECT game_id, game_name, game_description, release_year FROM videogame WHERE game_id = {0};", dato);
